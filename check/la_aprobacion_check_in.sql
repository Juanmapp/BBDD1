...
CREATE TABLE `check_in` (
  ...
  KEY `fk_check_in_formas_de_pagos1_idx` (`id_formas_de_pagos`),
  KEY `fk_check_in_huesped1_idx` (`id_huespedes`),
  CONSTRAINT `fk_check_in_formas_de_pagos1` FOREIGN KEY (`id_formas_de_pagos`) REFERENCES `formas_de_pagos` (`id_formas_de_pagos`),
  CONSTRAINT `fk_check_in_huesped1` FOREIGN KEY (`id_huespedes`) REFERENCES `huesped` (`id_huespedes`)
