...
--
-- Table structure for table `tpo_de_habitaciones`
--

DROP TABLE IF EXISTS `tpo_de_habitaciones`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tpo_de_habitaciones` (
...
--
-- Dumping data for table `tpo_de_habitaciones`
--

LOCK TABLES `tpo_de_habitaciones` WRITE;
/*!40000 ALTER TABLE `tpo_de_habitaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_de_habitaciones` ENABLE KEYS */;
UNLOCK TABLES;
